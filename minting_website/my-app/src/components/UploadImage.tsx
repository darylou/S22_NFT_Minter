...
function UploadImage() {
    ...
    const [tempB64, setTempB64] = React.useState<string | null>();
    ...
    interface sendURL{
      (url:string, date: string):void;
    }

    function sendIFPS(params: string, curr_date: string) {
